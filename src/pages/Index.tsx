      ...
      <section id="demande" className="py-16 bg-white relative">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="text-center mb-12">
            ...
            <div className="french-divider my-6"></div>
            <p className="text-france-navy max-w-2xl mx-auto">Complétez le formulaire ci-dessous pour effectuer votre demande de raccordement électrique. Notre équipe reste disponible durant toute la durée du processus de demande.</p>
